...
class TestUntitled():
  ...
  def test_untitled(self):
    ...
    self.driver.find_element(By.ID, "formInput#text").send_keys("kossty")
    self.driver.find_element(By.ID, "formInput#passowrd").click()
    self.driver.find_element(By.ID, "formInput#passowrd").send_keys("&UJM8ik,")
    ...
    self.driver.find_element(By.ID, "id_city").send_keys("Moscow")
    self.driver.find_element(By.CSS_SELECTOR, ".btn--lg").click()
